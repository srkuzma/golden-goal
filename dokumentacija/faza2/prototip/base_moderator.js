            ...
            <span class="col-md-10 col-lg-10 col-xl-11 col-sm-12">
                ...
                <div class="row">
                    <span class="col-9 d-none d-xl-block " style="margin-left: 0px; padding: 0px">
                        ...
                        <a class="btn btn-outline-warning view" href="standings_moderator.html" role="button">Tabela</a>

                        <a class="btn btn-outline-warning view" href="scorers_moderator.html" role="button">Lista strelaca</a>

                        <a class="btn btn-outline-warning view" href="user_rang_list_moderator.html" role="button">Rang lista korisnika</a>
                    </span>
                    ...
                    <span class="col-lg-6 col-md-6 col-sm-3 col-xs-4 d-xl-none" style="margin-top: 35px;">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu bg-dark text-warning justify-content-begin" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item text-warning bg-dark" href="played_moderator.html" role="button">Rezultati mečeva</a>
            
                                <a class="dropdown-item text-warning bg-dark" href="standings_moderator.html" role="button">Tabela</a>
            
                                <a class="dropdown-item text-warning bg-dark" href="scorers_moderator.html" role="button">Lista strelaca</a>
            
                                <a class="dropdown-item text-warning bg-dark" href="user_rang_list_moderator.html" role="button">Rang lista korisnika</a>
                            </div>
                        </div>
                    </span>

                    <span class="col-xl-3 d-xl-block d-none text-right" style="padding-left: 0px; padding-right: 0px">
                        <a id="username" class="btn btn-outline-warning" style="padding: 5px;" href="moderator_profile.html" role="button"><img src="images/manchester-united.png" id="user_icon"> kovacd</a>
                    ...
                    <span class="col-lg-6 col-md-6 col-sm-9 col-xs-8 d-xl-none text-right" style="margin-top: 20px;">
                        <a id="username" class="btn btn-outline-warning" href="moderator_profile.html" role="button"><img src="images/manchester-united.png" id="user_icon"> kovacd</a>
